...
那么在JOS中最多可以支持多大的矩阵乘法呢？（为了简化计算，只考虑方阵的情况）我们可以知道，JOS最多的进程数为1024，减去file system还有1023个，然后7种进程组合成的矩阵有N * N - 2个，所以算出来N最大为32，也就是A矩阵最大为30＊30。那么我们来用30＊30的A、B矩阵进行测试。非常暴力的方法。。
```c
int A[NORDER][NORDER] = {
    {1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
    {2, 5, 7, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
    {2, 1, 4, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
    {1, 1, 1, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
    {1, 1, 1, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
    {1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
    {2, 5, 7, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
    {2, 1, 4, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1, 1, 5, 6, 1, 1,1, 5, 6, 1, 1, 1, 5, 6, 1, 1},
...
int B[NORDER][NORDER] = {
    {1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
    {4, 5, 1, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
    {3, 8, 9, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
    {1, 1, 1, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
    {1, 1, 1, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
    {1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
    {4, 5, 1, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
    {3, 8, 9, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1, 1, 2, 7, 1, 1},
...
```
经过半分钟“漫长地”等待，总算是拿到了结果。
```
126 144 300 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72
123 168 315 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72
144 186 362 82 82 82 410 492 82 82 82 410 492 82 82 82 410 492 82 82 82 410 492 82 82 82 410 492 82 82
112 133 269 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65
112 133 269 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65
126 144 300 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72
123 168 315 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72 72 360 432 72 72
144 186 362 82 82 82 410 492 82 82 82 410 492 82 82 82 410 492 82 82 82 410 492 82 82 82 410 492 82 82
...
112 133 269 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65 65 325 390 65 65
```
已经达到了JOS理论上限，所以维数不可能再增加了。然后为了确认不能增加，维数改到31，果然得到了报错`[00001001] user panic in <unknown> at lib/fork.c:114: sys_exofork: out of environments`

至此，我们实现方式的正确性与可靠性检测完毕。
